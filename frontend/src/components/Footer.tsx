...
export default function Footer() {
  return (
    <footer className="wood-card-dark mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-sm">
            <Guitar size={16} className="text-wood-300" />
            <span className="text-wood-200">Chitara Mea</span>
            <span className="text-wood-600">|</span>
            <span className="text-wood-400">Acorduri și tabulaturi pentru chitară</span>
          </div>
