  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-3xl font-bold text-wood-800">Favorite</h1>
      </div>
      <p className="text-wood-500 mb-6">{favoriteSongs.length} cântece favorite</p>

      {favoriteSongs.length === 0 ? (
        <div className="text-center py-16">
          <Heart size={48} className="mx-auto mb-4 text-wood-200" />
          <p className="text-wood-400 text-lg mb-2">Nu ai cântece favorite încă</p>
